...
protected:
	...
	QList<GAgentGraphicsItem*> ListItemsToBePlaced(GAgentGraphicsItem* inWhichParent = 0) const;
	...
	virtual void AddItemToPlace(GAgentGraphicsItem* pItemToPlace, int remainingItemsToBeAdded = 0);
	...
	virtual void FinishedPlacingItems(GAgentGraphicsItem* inWhichParent);
...
// 	virtual void Event_SiblingItemsAdded(GAgentGraphicsItem* pInWhichParentItem);
...
// 	void NoMoreItemsToAddForNow(GAgentGraphicsItem* inWhichParent);
...
private:
	...
	QMultiHash<GAgentGraphicsItem*, GAgentGraphicsItem*> m_HashParent_ItemsToBePlaced;
