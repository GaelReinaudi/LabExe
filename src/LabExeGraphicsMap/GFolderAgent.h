...
// 	//! Constructor that provides the GFileSystemModel to be used for exploring 
// 	GFolderAgent(GFileSystemModel* pSystemModel, QObject *parent);
	~GFolderAgent();
...
protected:
    ...
    virtual GFileSystemModel* FileSystem();
